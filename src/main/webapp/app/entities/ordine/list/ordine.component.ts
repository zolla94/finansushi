...
export class OrdineComponent implements OnInit {
  ...
  trackId(_index: number, item: IOrdine): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IOrdine[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
