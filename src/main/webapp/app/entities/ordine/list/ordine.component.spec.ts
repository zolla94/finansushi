...
describe('Ordine Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ordine', component: OrdineComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ordines?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
