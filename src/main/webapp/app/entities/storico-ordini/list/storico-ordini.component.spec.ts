...
describe('StoricoOrdini Management Component', () => {
  let comp: StoricoOrdiniComponent;
  let fixture: ComponentFixture<StoricoOrdiniComponent>;
  let service: StoricoOrdiniService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'storico-ordini', component: StoricoOrdiniComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(StoricoOrdiniComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.storicoOrdinis?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
