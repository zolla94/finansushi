...
describe('Piatto Management Component', () => {
  let comp: PiattoComponent;
  let fixture: ComponentFixture<PiattoComponent>;
  let service: PiattoService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'piatto', component: PiattoComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PiattoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.piattos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
