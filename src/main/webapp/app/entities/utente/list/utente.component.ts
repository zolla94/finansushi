...
export class UtenteComponent implements OnInit {
  ...
  trackId(_index: number, item: IUtente): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IUtente[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
