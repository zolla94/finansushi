...
describe('Utente routing resolve service', () => {
  ...
  let routingResolveService: UtenteRoutingResolveService;
  let service: UtenteService;
  let resultUtente: IUtente | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(UtenteRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IUtente if id is not provided', () => {
      // GIVEN
      ...
      expect(resultUtente).toEqual(new Utente());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Utente })));
      mockActivatedRouteSnapshot.params = { id: 123 };
